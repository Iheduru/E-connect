...
export function MenteeLogin({ onBack }) {
  return (
<div>
  <button
    onClick={onBack}
  ...
  >
    <ArrowLeft className="h-3 w-6" /> {/* Adjusted width and height */}
    Back
  </button>
  ...
  <div className="bg-white p-6 w-full max-w-md">
    ...
    <div className="flex border-b mb-6">
      <button  onClick={() => onSelect('mentee')} className="flex-1 pb-2 text-center text-blue-900 border-b-2 border-green-400">
        Mentee
      </button>
      <button onClick={() => onSelect('mentor')} className="flex-1 pb-2 text-center text-blue-900">Mentor</button>
    </div>
    <form>
      <div className="mb-4">
